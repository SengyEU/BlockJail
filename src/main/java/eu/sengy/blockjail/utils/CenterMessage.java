...
public class CenterMessage {
    ...
    public enum Chat {
        ...
        private final static int CENTER_CHAT_PX = 95;
        private final static int MAX_CHAT_PX = 154;
        ...
        public static String mezery(String text){

            int length = 0;

            for(char ch: text.toCharArray()){

                Chat chatInfo = Chat.getDefaultFontInfo(ch);
                length+=chatInfo.getLength();
            }


            StringBuilder stringBuilder = new StringBuilder();
            for(int i = 0; i < (88 - length)/2; i++){
